...
class RadiusMassElementMomentum_Unittest(unittest.TestCase):
    def test_correlation_mass_thrust(self):
        ...
        for item in take_off_mass_lst:
            ...
            Thrust = RadiusMassElementMomentum(
                item,
    ...
    def test_correlation_mass_radius(self):
        ...
        for item in take_off_mass_lst:
            takeOffTipSpeed = 0.92 * const["soundSpeed"]
            Radius = RadiusMassElementMomentum(
                item,
                N_rotors=aircraftParameters["totalRotors"],
                N_blades=aircraftParameters["bladesPerRotor"],
                coaxial=aircraftParameters["coaxial"],
    ...
    def test_correlation_mass_Rotor_mass(self):
        ...
        for item in take_off_mass_lst:
            takeOffTipSpeed = 0.92 * const["soundSpeed"]
            Rotor_mass = RadiusMassElementMomentum(
                item,
                N_rotors=aircraftParameters["totalRotors"],
                N_blades=aircraftParameters["bladesPerRotor"],
                coaxial=aircraftParameters["coaxial"],
    ...
    def test_correlation_density_radius(self):
        ...
        for item in Density_lst:
            ...
            Radius = RadiusMassElementMomentum(
                ...
                V_tip=takeOffTipSpeed,
                print_results=False,
                changeConstants=("airDensity", item),
            )[0]
            Radius_lst.append(Radius)
    ...
    def test_correlation_gravity_thrust(self):
        ...
        for item in Gravity_lst:
            ...
            Thrust = RadiusMassElementMomentum(
                ...
                V_tip=takeOffTipSpeed,
                print_results=False,
                changeConstants=("gravityMars", item),
            )[1]
            Thrust_lst.append(Thrust)
    ...
    def test_zero_mass(self):
        ...
        takeOffTipSpeed = 0.92 * const["soundSpeed"]
        Mass_thrust = const["maxMass"] * (1 + const["margin"])  # kg
        Radius, Thrust = RadiusMassElementMomentum(
            mass,
            N_rotors=aircraftParameters["totalRotors"],
            N_blades=aircraftParameters["bladesPerRotor"],
            coaxial=aircraftParameters["coaxial"],
    ...
    def test_zero_N_rotors(self):
        ...
        takeOffTipSpeed = 0.92 * const["soundSpeed"]
        Mass_thrust = const["maxMass"] * (1 + const["margin"])  # kg
        Return = RadiusMassElementMomentum(
            M=Mass_thrust,
            N_rotors=N_rotors,
            N_blades=aircraftParameters["bladesPerRotor"],
            coaxial=aircraftParameters["coaxial"],
...
class size_power_subsystem_Unittest(unittest.TestCase):
    def test_correlation_T0thrust_battery_mass(self):
        ...
        for item in T0thrust_lst:
            battery_mass = size_power_subsystem(
                aircraftParameters["rotorRadius"],
                item,
                aircraftParameters["cruiseThrust"],
...
class Class2weight_Unittest(unittest.TestCase):
    ...
    def test_correlation_wingbraced_wing_weight(self):
        ...
        wing_weight_braced = Class2Weight(
            aircraftParameters["rotorRadius"],
            aircraftParameters["rotorMass"],
            Mass_design,
            const["ultimateLoad"],
        ...
        wing_weight_nonbraced = Class2Weight(
            aircraftParameters["rotorRadius"],
            aircraftParameters["rotorMass"],
            Mass_design,
            const["ultimateLoad"],
    ...
    def test_negative_zero_values(self):
        ...
        self.assertTrue(
            Return1 == "Rotor radius has to be greater than zero."
            and Return2 == "Rotor mass has to be greater than zero."
            and Return3 == "Take-off mass has to be greater than zero."
            and Return4 == "Cruise speed has to be greater than zero."
        )
...
class RotorClimbPerformance_Unittest(unittest.TestCase):
    ...
    def test_correlation_Rotor_Radius_ROC(self):
        ...
        for item in rotor_radius_lst:
            ROC = RotorClimbPerf(Mass_design, item, aircraftParameters["totalRotors"], Print=False)
            ROC_lst.append(ROC)
    ...
    def test_correlation_N_rotors_ROC(self):
        ...
        for item in N_rotors_lst:
            ROC = RotorClimbPerf(Mass_design, aircraftParameters["rotorRadius"], item, Print=False)
            ROC_lst.append(ROC)
