...
def test_function_sensitivity(Print=False):
    outputs = ['Range', 'Total mass', 'Rotor mass', 'Battery mass', 'Body mass', 'Wing mass', 'Tail mass',
               'Rotor radius', 'Wingspan', 'Chord', 'Cruise thrust', 'Max power']
...
if __name__ == '__main__':
    ...
    assumedValues = ['cl', 'cd', 't/c', 'battery power density', 'battery energy density', 'blade density',
                     'fill factor', 'ultimate load', 'oswald', 'take off time']
    bounds3 = [[1.6, 2], [0.01, 0.1], [0.01, 0.02], [1200, 1500], [430, 600], [1300, 1525],
               [0.07, 0.085], [1, 1.75], [0.9, 1], [300, 600]]
    ...
    problem3 = {
        'num_vars': 10,
        'names': ['cl', 'cd', 't/c', 'takeoffBatteryPowerDensity', 'takeoffBatteryEnergyDensity', 'bladeDensity',
                  'fillFactor', 'ultimateLoad', 'takeOffTime', 'oswald'],
        'bounds': bounds3
    }
