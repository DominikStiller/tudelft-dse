...
def RangeCalc(Wto, Wtot, R, V_cr):
    ...
    m_TO = max(
        Power / const["takeoffBatteryPowerDensity"], E_TO / const["takeoffBatteryEnergyDensity"]
    )
    ...
    ] - E_TO * 2  # Use all remaining mass for batteries
...
def Class2Weight(
    ...
    Wf = 0.23 * np.sqrt(Vdive * lt / (bf + hf)) * S_g**1.2
