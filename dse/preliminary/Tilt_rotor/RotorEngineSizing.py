...
def RadiusMassElementMomentum(M, N_rotors, N_blades, coaxial, V_tip, print_results=False):
    ...
    x_cord_top = [1, 0.99838, 0.99417, 0.98825, 0.98075, 0.97111, 0.95884,0.94389,0.92639,0.90641,0.88406,0.85947,0.83277,
    ...
    Area = (S1223_top.integral(0, 1) - S1223_bottom.integral(0, 1))* c
    fillfactor = 0.3
