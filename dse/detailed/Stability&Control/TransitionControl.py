...
plt.xlabel("Time [s]")
format_plot()
save_plot("/Users/thomas/Documents/Thomas' bestanden/TU Delft/BSC3/Q4 - DSE/Figures", "XVelocity_vs_Time_Transition")
plt.show()
...
plt.legend()
format_plot()
save_plot("/Users/thomas/Documents/Thomas' bestanden/TU Delft/BSC3/Q4 - DSE/Figures", "Thrust_vs_Time_Transition")
plt.show()
