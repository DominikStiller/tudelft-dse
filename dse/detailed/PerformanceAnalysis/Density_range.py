...
if __name__ == '__main__':
    ...
    power_required = 2 * (np.array([15723.13174, 19653.91467, 23584.69761, 27515.48054, 31446.26347])
    ...
    rel = sc.PchipInterpolator(np.array([0.01, 0.015, 0.02]), np.array([max_range[0], max_range[2], max_range[-1]]))
    r3 = rel(d2)
